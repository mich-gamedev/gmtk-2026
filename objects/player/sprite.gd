...
func _physics_process(delta: float) -> void:
	scale.x = lerp(scale.x, remap(player.virt_velocity.length(), 0, player.speed, 1, 1.33), 1 - 0.000000001 ** delta)
	scale.y = lerp(scale.y, remap(player.virt_velocity.length(), 0, player.speed, 1, 1 / 1.33), 1 - 0.000000001 ** delta)
